...
| [audiomentations](https://github.com/iver56/audiomentations) | Python | A Python library for audio data augmentation, e.g. time stretch, pitch shift, add noise, add room reverberation |
